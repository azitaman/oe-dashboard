    ...
    return (
      <Accordion accordion id="mainContent">
        {dataList.map((container, index) => {
          ...
          } else if (collectionName == 'VideosData') {
            prefix = <FontAwesomeIcon icon={faFileVideo} />
          } else if (collectionName == 'StreamsData') {
            prefix = <FontAwesomeIcon icon={faVideo} />
          }
              ...
              >
                ...
                <div>
                  <span style={{ marginTop: imagePanel && '4px', zIndex: 99 }}>
                    {openEditable && (
                      ...
                      >
                        ...
                        />}
                        {isDownloadButtonVisible && <ControlButton
                          Icon={faFileDownload}
                          font={font}
                          bluenavy={true}
                          hlcolor={hlcolor}
                          ...
                          onClick={e => {
                            ...
                            isDownloadButtonVisible && (downloadItem && downloadItem(index))
                          }}
                        />}
                        <ControlButton
                          Icon={faTrashAlt}
                  ...
                  >
                    ...
                    {imagePanel && (
                      <span onClick={e => this.onClickIcon(e, index)} style={{ width: '20%', display: 'inline-block', textAlign: 'center' }}>
                        {prefix}
                      </span>
                    )}
                    {!imagePanel && (
...
AccordionList.propTypes = {
  ...
  isDownloadButtonVisible: PropTypes.bool
}
